...
public class Capitulo08 extends Capitulo {
    ...
    public List<Dialogo> getDialogos(Player player) {
        ...
        opcoes.add(Dialogo.opcao("Aceitar a proposta de Noor", p -> p.concluirCapitulo("FLAG_CONTRATO_ACEITO"), List.of(
        ...
        if (player.isCapituloConcluido("FLAG_JAMES")) {
            opcoes.add(Dialogo.opcao("Pedir análise de James", p -> {}, List.of(
